...
- **`/stats` now shows the number of voters next to each country average** — e.g. `🇨🇭 Швейцарія — 9.2 балів (12 голосів)`. The vote count uses correct Ukrainian plural forms (голос / голоси / голосів) including the 11–14 exception.
