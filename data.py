...
def calculate_all_scores():
    ...
    - Якщо передбачена країна не потрапила в офіційний топ-25 — 0 балів.
    - Незаповнені слоти теж = 0 балів. Середнє завжди ділиться на TOP_N (25),
      щоб користувач, який зробив лише 1 «впевнене» передбачення, не міг
      обійти того, хто чесно заповнив усі 25.
    """
